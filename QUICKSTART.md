# SortNStore - Quick Reference

## Getting Started

### Launch Dashboard
- **Desktop Shortcut**: Double-click "SortNStore Dashboard"
...
- **GitHub Issues**: https://github.com/Atomsk865/SortNStore/issues
- **Logs Location**: `<INSTALL_DIR>\service-logs\` (default: `C:\SortNStore\service-logs\`)
- **Config Location**: `<INSTALL_DIR>\` (default: `C:\SortNStore\`)
