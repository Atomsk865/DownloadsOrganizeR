...
def get_auth_settings():
    ...
    def _get_auth_settings():
        ...
        from OrganizerDashboard.auth.auth import _auth_manager
...
def update_auth_settings():
    ...
    from OrganizerDashboard.auth.auth import requires_auth, initialize_auth_manager
...
def test_auth():
    ...
    from OrganizerDashboard.auth.auth import requires_auth, _auth_manager
