#!/usr/bin/env python3
"""
BatchOrganizer.py - One-time file organization service

Unlike Organizer.py which continuously watches a folder,
BatchOrganizer is designed to be run once (manually or via scheduler)
to organize files in specified watch folders.

Usage:
    python BatchOrganizer.py                    # Organize all configured watch folders
    python BatchOrganizer.py --folder "C:/path" # Organize specific folder
    python BatchOrganizer.py --dry-run          # Preview without moving files
"""
