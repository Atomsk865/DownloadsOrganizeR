...
def setup_page():
    ...
    try:
        from SortNStoreDashboard.auth.auth import LDAP_AVAILABLE, WINDOWS_AUTH_AVAILABLE
        if LDAP_AVAILABLE:
...
def organizer_status():
    ...
    from SortNStoreDashboard.helpers.helpers import find_organizer_proc, service_running
...
def start_organizer_process():
        ...
        from SortNStoreDashboard.helpers.helpers import find_organizer_proc
...
def setup_initialize():
    ...
    from SortNStoreDashboard.config_runtime import get_dashboard_config, get_config, save_config, save_dashboard_config
    dash_cfg = get_dashboard_config()
...
def setup_reset():
    ...
    from SortNStoreDashboard.auth.auth import requires_auth, requires_right
    @requires_auth
    @requires_right('manage_config')
    def _reset():
        from SortNStoreDashboard.config_runtime import reload_dashboard_config, save_dashboard_config
